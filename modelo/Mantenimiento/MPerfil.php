<?php
   ...
   class MPerfil{
      ...
      public function RegistroPerfil($idPerfil,$PerfilNombre,$PerfilDescripcion,$PerfilEstado,$login_idLog){
       ...
       public function ActualizarPermisos($idPermisos,$Permiso1,$Permiso2,$Permiso3,$idPerfil,$login_idLog){
           $sql="CALL `SP_PERMISOS_ACTUALIZAR`('$idPermisos','$Permiso1','$Permiso2','$Permiso3','$idPerfil','$login_idLog');";
           return ejecutarConsulta($sql);
       }
