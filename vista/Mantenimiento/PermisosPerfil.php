               ...
               <div class="card-body" id="cuerpo">
                 <form  id="FormularioPermisos" method="POST" autocomplete="off">
                       ...
                       <input type="hidden" id="idPermisos" name="idPermisos" >
                        ...
                        <div class="row">
                            <label class="col-md-3 col-form-label texto-x12"><b>MÓDULO GESTIÓN:</b></label>
                            <div class="col-md-3  mt-1">
                               <div class="row">
                                    <label class=" texto-x12 col-md-6">
                                    <input type="radio" class="m_gestion" name="m_gestion" value="1" >
                                    <span></span>SI</label>
                                    <label class=" texto-x12 col-md-6">
                                    <input type="radio" class="m_gestion" name="m_gestion" value="0" >
                                    <span></span>NO</label>
                               </div>
                            </div>
                        </div>
