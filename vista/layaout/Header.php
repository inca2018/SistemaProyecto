...
<head>
   ...
   <link rel="stylesheet" href="<?php echo $conexionConfig->ruta(); ?>vendor/tree/jqtree.css">
<link rel="stylesheet" href="<?php echo $conexionConfig->ruta(); ?>vendor/treeJS/dist/themes/default/style.min.css" />
</head>
