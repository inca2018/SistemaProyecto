<?php
   ...
   $general = new MGeneral();
    ...
    $Permiso2=isset($_POST["m_mantenimiento"])?limpiarCadena($_POST["m_mantenimiento"]):"";
   ...
   switch($_GET['op']){
    ...
    case 'ActualizarPermisos':
        $rspta=array("Error"=>false,"Mensaje"=>"","Registro"=>false);
        $RespuestaRegistro=$mantenimiento->ActualizarPermisos($idPermisos,$Permiso1,$Permiso2,$Permiso3,$idPerfil,$login_idLog);
            if($RespuestaRegistro){
                $rspta["Registro"]=true;
